...
include"Accueil.php";
$affichageRecl = $bdd->query("Select * from employe");
?>
<?php
...
<tr> <th>prenom</th>
<td> <input type="text" name="prenom" require pattern="[A-Za-zÀ-ÿ\s]{2,20}"/> </td>
</tr>
<tr> <th>role</th>
<td> <input type="text" name="role"  require pattern="[A-Za-zÀ-ÿ\s]{2,20}"/> </td>
</tr>
<tr> <th>contact</th>
