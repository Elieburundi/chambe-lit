                ...
                <?php while ($ContactRecup = $affichageCont->fetch(PDO::FETCH_ASSOC)) { ?>
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="affichagecontacte.php?sup=<?php echo $ContactRecup["id_contact"]; ?>" class="btn btn-danger" onclick="return confirm('Êtes-vous sûr de vouloir supprimer ce contacte ?');">Supprimer</a>
                        </td>
                    </tr>
                <?php } ?>
            </tbody>
